...
#ifndef NonPeriodic3D_MPI_H
#define NonPeriodic3D_MPI_H
...
extern double xl, xr, yl, yr, zl, zr, Lx, Ly, Lz, dx, dy;

extern double alphal, betal, alphar, betar, Lambda;

extern double **Dz, **Dzz, **Operator, *z, ****rhsPDE, **leftBC, **rightBC, determinant;
